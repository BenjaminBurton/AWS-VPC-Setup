...
```js
[[https://github.com/BenjaminBurton/MicrosoftAzureResume](https://github.com/BenjaminBurton/AWS-VPC-Setup)](https://github.com/BenjaminBurton/AWS-VPC-Setup/blob/main/README.md)
